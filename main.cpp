...
int main()
    ...
    printf("3.  my_strchr('a'): Character '%c' found at position: %ld\n",
           'a', (long int)(my_strchr(test, 'a') - test));
...
/*
    char *strdup_func[] = my_strdup(test);
    printf("9. my_strdup: %s\n", strdup_func);
    free(strdup_func);
*/

    char s2[] = "wey";
    char* p = my_strstr(test, s2);
    printf("10. my_strstr: First occurrence is %s", p);
